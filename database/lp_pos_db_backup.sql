...
set autocommit=0;
INSERT INTO `auth_user` (`id`, `password`, `last_login`, `is_superuser`, `username`, `first_name`, `last_name`, `email`, `is_staff`, `is_active`, `date_joined`) VALUES (1,'pbkdf2_sha256$1000000$KKq6trfdqC14HjIERQdPOM$XrduLhiFn5WoIszW+qf+xJtIYtqcFJUUHCAMxhFmcqQ=','2025-10-12 02:08:11.941309',1,'JuanL','','','lizarazojuanandres@gmail.com',1,1,'2025-10-11 22:59:12.411276');
...
set autocommit=0;
INSERT INTO `categoria` (`id`, `nombre`) VALUES (1,'Lacteos'),
(2,'Quesos');
...
set autocommit=0;
INSERT INTO `cliente` (`id`, `documento`, `nombres`, `apellidos`, `correo`, `telefono`) VALUES (1,'12345678','Pepito','Perez','pepito@gmail.com','12342155124'),
...
set autocommit=0;
INSERT INTO `django_migrations` (`id`, `app`, `name`, `applied`) VALUES (1,'contenttypes','0001_initial','2025-10-11 22:51:04.363904'),
...
set autocommit=0;
INSERT INTO `lote` (`id`, `producto_id`, `numero_lote`, `cantidad_disponible`, `costo_unitario_lote`, `fecha_caducidad`, `fecha_entrada`) VALUES (1,1,'LCH-A1',98,2500.00,'2025-10-30','2025-09-01 10:00:00'),
...
set autocommit=0;
INSERT INTO `movimiento_inventario` (`id`, `producto_id`, `lote_id`, `cantidad`, `tipo_movimiento`, `fecha_movimiento`, `descripcion`, `venta_id`, `reabastecimiento_id`) VALUES (1,1,1,100,'ENTRADA','2025-10-10 22:48:22','Reabastecimiento inicial Lote A1',NULL,NULL),
...
set autocommit=0;
INSERT INTO `pqrs` (`id`, `tipo`, `descripcion`, `respuesta`, `estado`, `fecha_creacion`, `fecha_actualizacion`, `cliente_id`, `usuario_id`) VALUES (1,'SUGERENCIA','Más productos saludables',NULL,'en_proceso','2025-07-01 10:00:00',NULL,1,2);
...
set autocommit=0;
INSERT INTO `pqrs_historial` (`id`, `pqrs_id`, `usuario_id`, `estado_anterior`, `estado_nuevo`, `descripcion_cambio`, `fecha_cambio`) VALUES (1,1,2,'pendiente','en_proceso','Se asigna el caso al administrador para evaluar la solicitud.','2025-10-10 22:48:22');
...
set autocommit=0;
INSERT INTO `producto` (`id`, `nombre`, `precio_unitario`, `descripcion`, `stock_minimo`, `categoria_id`) VALUES (1,'Leche Entera 1L',3800.00,'Leche pasteurizada',10,1),
(2,'Queso Campesino 500g',9500.00,'Queso fresco de vaca',5,2);
...
CREATE TABLE `reabastecimiento_detalle` (
  ...
  KEY `producto_id` (`producto_id`),
  CONSTRAINT `fk_reabastecimiento_detalle_producto` FOREIGN KEY (`producto_id`) REFERENCES `producto` (`id`) ON UPDATE CASCADE,
...
set autocommit=0;
INSERT INTO `usuario` (`id`, `documento`, `nombres`, `apellidos`, `correo`, `telefono`, `contrasena`, `estado`, `fecha_creacion`, `ultimo_login`, `rol_id`, `reset_token`, `reset_token_expiracion`) VALUES (1,'1014477103','Juan Andres','Lizarazo','liza@gmail.com','3105416287','pass_hash','activo','2025-10-10 22:48:22',NULL,2,NULL,NULL),
...
set autocommit=0;
INSERT INTO `venta` (`id`, `fecha_venta`, `metodo_pago`, `canal_venta`, `cliente_id`, `usuario_id`) VALUES (1,'2025-09-02 10:00:00','Efectivo','Tienda',1,1),
...
set autocommit=0;
INSERT INTO `venta_detalle` (`id`, `venta_id`, `producto_id`, `lote_id`, `cantidad`, `subtotal`) VALUES (1,1,1,1,2,7600.00),
(2,2,2,2,1,9500.00);
...
/*!50003 DROP PROCEDURE IF EXISTS `PA_REGISTRAR_REABASTECIMIENTO` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_REGISTRAR_REABASTECIMIENTO`(
...
BEGIN
    ...
    INSERT INTO reabastecimiento_detalle (
        reabastecimiento_id,
        producto_id,
        cantidad,
        costo_unitario
...
/*!50003 SET @saved_sql_mode       = @@sql_mode */ ;
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PA_REGISTRAR_VENTA_DETALLE` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET collation_connection  = utf8mb4_uca1400_ai_ci */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PA_REGISTRAR_VENTA_DETALLE`(
    IN p_venta_id INT,
    IN p_producto_id INT,
    IN p_lote_id INT,
    IN p_cantidad INT,
...
-- Dump completed on 2025-10-11 22:08:15
