...
(89,'Can add pedido',23,'add_pedido'),
(90,'Can change pedido',23,'change_pedido'),
(91,'Can delete pedido',23,'delete_pedido'),
(92,'Can view pedido',23,'view_pedido'),
(93,'Can add pedido detalle',24,'add_pedidodetalle'),
(94,'Can change pedido detalle',24,'change_pedidodetalle'),
(95,'Can delete pedido detalle',24,'delete_pedidodetalle'),
(96,'Can view pedido detalle',24,'view_pedidodetalle'),
(97,'Can add rol',28,'add_rol'),
(98,'Can change rol',28,'change_rol'),
(99,'Can delete rol',28,'delete_rol'),
(100,'Can view rol',28,'view_rol'),
(101,'Can add usuario groups',29,'add_usuariogroups'),
(102,'Can change usuario groups',29,'change_usuariogroups'),
(103,'Can delete usuario groups',29,'delete_usuariogroups'),
(104,'Can view usuario groups',29,'view_usuariogroups'),
(105,'Can add usuario user permissions',30,'add_usuariouserpermissions'),
(106,'Can change usuario user permissions',30,'change_usuariouserpermissions'),
(107,'Can delete usuario user permissions',30,'delete_usuariouserpermissions'),
(108,'Can view usuario user permissions',30,'view_usuariouserpermissions'),
(109,'Can add usuario',31,'add_usuario'),
(110,'Can change usuario',31,'change_usuario'),
(111,'Can delete usuario',31,'delete_usuario'),
(112,'Can view usuario',31,'view_usuario'),
(113,'Can add categoria',32,'add_categoria'),
(114,'Can change categoria',32,'change_categoria'),
(115,'Can delete categoria',32,'delete_categoria'),
(116,'Can view categoria',32,'view_categoria'),
(117,'Can add lote',33,'add_lote'),
(118,'Can change lote',33,'change_lote'),
(119,'Can delete lote',33,'delete_lote'),
(120,'Can view lote',33,'view_lote'),
(121,'Can add movimiento inventario',34,'add_movimientoinventario'),
(122,'Can change movimiento inventario',34,'change_movimientoinventario'),
(123,'Can delete movimiento inventario',34,'delete_movimientoinventario'),
(124,'Can view movimiento inventario',34,'view_movimientoinventario'),
(125,'Can add producto',35,'add_producto'),
(126,'Can change producto',35,'change_producto'),
(127,'Can delete producto',35,'delete_producto'),
(128,'Can view producto',35,'view_producto'),
(129,'Can add pqrs',25,'add_pqrs'),
(130,'Can change pqrs',25,'change_pqrs'),
(131,'Can delete pqrs',25,'delete_pqrs'),
(132,'Can view pqrs',25,'view_pqrs'),
(133,'Can add pqrs historial',26,'add_pqrshistorial'),
(134,'Can change pqrs historial',26,'change_pqrshistorial'),
(135,'Can delete pqrs historial',26,'delete_pqrshistorial'),
(136,'Can view pqrs historial',26,'view_pqrshistorial'),
(137,'Can add proveedor',36,'add_proveedor'),
(138,'Can change proveedor',36,'change_proveedor'),
(139,'Can delete proveedor',36,'delete_proveedor'),
(140,'Can view proveedor',36,'view_proveedor'),
(141,'Can add reabastecimiento',37,'add_reabastecimiento'),
(142,'Can change reabastecimiento',37,'change_reabastecimiento'),
(143,'Can delete reabastecimiento',37,'delete_reabastecimiento'),
(144,'Can view reabastecimiento',37,'view_reabastecimiento'),
(145,'Can add reabastecimiento detalle',38,'add_reabastecimientodetalle'),
(146,'Can change reabastecimiento detalle',38,'change_reabastecimientodetalle'),
(147,'Can delete reabastecimiento detalle',38,'delete_reabastecimientodetalle'),
(148,'Can view reabastecimiento detalle',38,'view_reabastecimientodetalle'),
(149,'Can add Cliente',27,'add_cliente'),
(150,'Can change Cliente',27,'change_cliente'),
(151,'Can delete Cliente',27,'delete_cliente'),
(152,'Can view Cliente',27,'view_cliente'),
(153,'Can add pedido',39,'add_pedido'),
(154,'Can change pedido',39,'change_pedido'),
(155,'Can delete pedido',39,'delete_pedido'),
(156,'Can view pedido',39,'view_pedido'),
(157,'Can add pedido detalle',40,'add_pedidodetalle'),
(158,'Can change pedido detalle',40,'change_pedidodetalle'),
(159,'Can delete pedido detalle',40,'delete_pedidodetalle'),
(160,'Can view pedido detalle',40,'view_pedidodetalle'),
(161,'Can add venta detalle',41,'add_ventadetalle'),
(162,'Can change venta detalle',41,'change_ventadetalle'),
(163,'Can delete venta detalle',41,'delete_ventadetalle'),
(164,'Can view venta detalle',41,'view_ventadetalle'),
(165,'Can add venta',42,'add_venta'),
(166,'Can change venta',42,'change_venta'),
(167,'Can delete venta',42,'delete_venta'),
(168,'Can view venta',42,'view_venta');
...
(32,'inventory','categoria'),
(33,'inventory','lote'),
(34,'inventory','movimientoinventario'),
(35,'inventory','producto'),
(39,'pos','pedido'),
(40,'pos','pedidodetalle'),
(42,'pos','venta'),
(41,'pos','ventadetalle'),
(25,'pqrs','pqrs'),
(26,'pqrs','pqrshistorial'),
(6,'sessions','session'),
(36,'suppliers','proveedor'),
(37,'suppliers','reabastecimiento'),
(38,'suppliers','reabastecimientodetalle'),
(28,'users','rol'),
(31,'users','usuario'),
(29,'users','usuariogroups'),
(30,'users','usuariouserpermissions');
...
(40,'core','0019_pedido_pedidodetalle','2025-11-08 01:37:19.924986'),
(41,'contenttypes','0001_initial','2025-11-08 22:58:28.199864'),
(42,'contenttypes','0002_remove_content_type_name','2025-11-08 22:59:47.757555'),
(43,'auth','0001_initial','2025-11-08 23:01:14.899311'),
(44,'auth','0002_alter_permission_name_max_length','2025-11-08 23:01:14.908686'),
(45,'auth','0003_alter_user_email_max_length','2025-11-08 23:01:14.918042'),
(46,'auth','0004_alter_user_username_opts','2025-11-08 23:01:14.933882'),
(47,'auth','0005_alter_user_last_login_null','2025-11-08 23:01:14.942918'),
(48,'auth','0006_require_contenttypes_0002','2025-11-08 23:01:14.952130'),
(49,'auth','0007_alter_validators_add_error_messages','2025-11-08 23:01:14.961457'),
(50,'auth','0008_alter_user_username_max_length','2025-11-08 23:01:14.970692'),
(51,'auth','0009_alter_user_last_name_max_length','2025-11-08 23:01:14.979880'),
(52,'auth','0010_alter_group_name_max_length','2025-11-08 23:01:14.989055'),
(53,'auth','0011_update_proxy_permissions','2025-11-08 23:01:14.998268'),
(54,'auth','0012_alter_user_first_name_max_length','2025-11-08 23:01:15.007423'),
(55,'users','0001_initial','2025-11-08 23:01:15.016638'),
(56,'admin','0001_initial','2025-11-08 23:01:15.025146'),
(57,'admin','0002_logentry_remove_auto_add','2025-11-08 23:01:15.034463'),
(58,'admin','0003_logentry_add_action_flag_choices','2025-11-08 23:01:15.043562'),
(60,'suppliers','0001_initial','2025-11-09 00:32:16.836961'),
(63,'pos','0001_initial','2025-11-09 02:57:06.041334');
...
('553xy755tc3nlazr48lwyegjm4ca272w','.eJxVjDsOAiEUAO9CbQjyx9LeM5AHjyerBpJltzLe3ZBsoe3MZN4swr7VuI-yxgXZhWl2-mUJ8rO0KfAB7d557m1bl8Rnwg87-K1jeV2P9m9QYdS5JZsdaY1ZmaCMCsI4KTBQkkGADMUGe1ZaeKnAF7KETtgEmrQr4JJnny_F9Ddd:1vHtPt:X896ETXM84slxYXUBmgSM--L9hlSEQdtSMUBm5gWd5I','2025-11-09 01:06:25.311740'),
...
('ps0zj1lnx515tr43jn2zcfwemqpuhr1v','.eJxVjDsOAiEUAO9CbQjyx9LeM5AHjyerBpJltzLe3ZBsoe3MZN4swr7VuI-yxgXZhWl2-mUJ8rO0KfAB7d557m1bl8Rnwg87-K1jeV2P9m9QYdS5JZsdaY1ZmaCMCsI4KTBQkkGADMUGe1ZaeKnAF7KETtgEmrQr4JJnny_F9Ddd:1vHA5p:oSGzbTn_Fx_Gio0tABMcwYLyYIWALqQq54GMZmaU43k','2025-11-07 00:42:41.953980'),
('pvii99g57f9kf4cb1vuxgj5naat978j2','.eJxVjDsOAiEUAO9CbQjyx9LeM5AHjyerBpJltzLe3ZBsoe3MZN4swr7VuI-yxgXZhWl2-mUJ8rO0KfAB7d557m1bl8Rnwg87-K1jeV2P9m9QYdS5JZsdaY1ZmaCMCsI4KTBQkkGADMUGe1ZaeKnAF7KETtgEmrQr4JJnny_F9Ddd:1vHw1H:YwvmQZDQDosl1mspnYBcL_dgBPkuPEiCSsh67bMVXUs','2025-11-09 03:53:11.050008'),
...
('v8umxg94mx5f837nw2m4a4l6ngusifix','.eJxVjLsKwzAMAP9FczGRY_zI2L3fYCRLadIWB-JkKv33EsjQrnfHvSHTvk15b7rmWWAAC5dfxlSeWg8hD6r3xZSlbuvM5kjMaZu5LaKv69n-DSZqEwyAIuTEBeWoNgak3vqgPrixQxs1-aJYXOSE0neeOGjqZcTRcUGmUODzBenrOGM:1vHuma:EaVPMzHcMWtCvqbtN7rGoAtp4fpBKv1F7P1nKME7AHo','2025-11-09 02:33:56.850593');
/*!40000 ALTER TABLE `django_session` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `inventory_categoria`
--

DROP TABLE IF EXISTS `inventory_categoria`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `inventory_categoria` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(25) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
--
-- Dumping data for table `inventory_categoria`
--

LOCK TABLES `inventory_categoria` WRITE;
/*!40000 ALTER TABLE `inventory_categoria` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `inventory_categoria` VALUES
(1,'Sin categoría');
/*!40000 ALTER TABLE `inventory_categoria` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `inventory_lote`
--

DROP TABLE IF EXISTS `inventory_lote`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `inventory_lote` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `inventory_lote`
--

LOCK TABLES `inventory_lote` WRITE;
/*!40000 ALTER TABLE `inventory_lote` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `inventory_lote` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `inventory_movimientoinventario`
--

DROP TABLE IF EXISTS `inventory_movimientoinventario`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `inventory_movimientoinventario` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `inventory_movimientoinventario`
--

LOCK TABLES `inventory_movimientoinventario` WRITE;
/*!40000 ALTER TABLE `inventory_movimientoinventario` DISABLE KEYS */;
set autocommit=0;
/*!40000 ALTER TABLE `inventory_movimientoinventario` ENABLE KEYS */;
UNLOCK TABLES;
commit;

--
-- Table structure for table `inventory_producto`
--

DROP TABLE IF EXISTS `inventory_producto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `inventory_producto` (
  ...
  `descripcion` varchar(255) DEFAULT NULL,
  `stock_minimo` int(10) unsigned NOT NULL CHECK (`stock_minimo` >= 0),
...
--
-- Dumping data for table `inventory_producto`
--

LOCK TABLES `inventory_producto` WRITE;
/*!40000 ALTER TABLE `inventory_producto` DISABLE KEYS */;
set autocommit=0;
INSERT INTO `inventory_producto` VALUES
(1,'Producto Test',1000.00,0.00,'Prueba',5,0,1);
/*!40000 ALTER TABLE `inventory_producto` ENABLE KEYS */;
UNLOCK TABLES;
commit;
...
(2,'1234567','Admin','Principal','admin@playita.com','32124551','admin_hash','activo','2025-10-10 22:48:22','2025-11-09 07:03:56',1,NULL,NULL),
...
(4,'10000000','Admin','ROL 1','admin_final_rol1@laplayita.com',NULL,'pbkdf2_sha256$1000000$5IUYpFqgilB2EvaR9GQJya$hH7HV5VkSrpqZSxNsg5r9+/o+2BQyzYwWbPiyTDV204=','activo','2025-10-13 19:08:10','2025-11-09 06:55:27',1,NULL,NULL);
...
-- Dump completed on 2025-11-09 20:25:18
